...
export const MOCK_CANDIDATES: Candidate[] = [
  ...
  { id: "2", name: "Markus Becker", role: "Software Engineer", team_id: "a", team: { id: "a", name: "Team A" }, bio: "Markus champions remote-work policies and data-driven decision making.", bio_de: "Markus setzt sich für Remote-Arbeit und datengestützte Entscheidungen ein.", photo_url: undefined, is_independent: false, is_active: true, sort_order: 2, created_at: "2026-01-01T00:00:00Z", updated_at: "2026-01-01T00:00:00Z" },
  { id: "3", name: "Julia Schneider", role: "Project Manager", team_id: "b", team: { id: "b", name: "Team B" }, bio: "Julia leads cross-functional initiatives and believes in inclusive processes.", bio_de: "Julia leitet bereichsübergreifende Initiativen und glaubt an inklusive Prozesse.", photo_url: undefined, is_independent: false, is_active: true, sort_order: 3, created_at: "2026-01-01T00:00:00Z", updated_at: "2026-01-01T00:00:00Z" },
  { id: "4", name: "Thomas Lehmann", role: "Production Specialist", team_id: "b", team: { id: "b", name: "Team B" }, bio: "Thomas focuses on workplace safety and ergonomics on the production floor.", bio_de: "Thomas konzentriert sich auf Arbeitssicherheit und Ergonomie.", photo_url: undefined, is_independent: false, is_active: true, sort_order: 4, created_at: "2026-01-01T00:00:00Z", updated_at: "2026-01-01T00:00:00Z" },
  { id: "5", name: "Selina Yilmaz", role: "Quality Manager", team_id: "c", team: { id: "c", name: "Team C" }, bio: "Selina drives continuous improvement and has negotiated impactful quality agreements.", bio_de: "Selina treibt kontinuierliche Verbesserungen voran.", photo_url: undefined, is_independent: false, is_active: true, sort_order: 5, created_at: "2026-01-01T00:00:00Z", updated_at: "2026-01-01T00:00:00Z" },
  { id: "6", name: "Peter König", role: "IT Architect", team_id: undefined, team: undefined, bio: "Peter runs independently, focusing on digital transformation and data privacy.", bio_de: "Peter kandidiert unabhängig mit Fokus auf digitale Transformation.", photo_url: undefined, is_independent: true, is_active: true, sort_order: 6, created_at: "2026-01-01T00:00:00Z", updated_at: "2026-01-01T00:00:00Z" },
];

export const MOCK_ELECTION: Election = {
  id: "e1",
  title: "Works Council Election 2026",
  title_de: "Betriebsratswahl 2026",
  start_date: "2026-06-10",
  end_date: "2026-06-21",
  is_active: true,
  created_at: "2026-01-01T00:00:00Z",
  steps: [
    { id: "s1", step_number: 1, title: "Announcement", title_de: "Bekanntmachung", description: "We inform you about the election.", description_de: "Wir informieren über die Wahl.", date_label: "April 2026", date_label_de: "April 2026", is_completed: true, is_current: false },
    { id: "s2", step_number: 2, title: "Nomination", title_de: "Nominierung", description: "Employees can nominate themselves or others.", description_de: "Mitarbeiter können sich selbst oder andere nominieren.", date_label: "May 2026", date_label_de: "Mai 2026", is_completed: true, is_current: false },
    { id: "s3", step_number: 3, title: "Candidate list", title_de: "Kandidatenliste", description: "The final list of candidates is published.", description_de: "Die endgültige Kandidatenliste wird veröffentlicht.", date_label: "End of May 2026", date_label_de: "Ende Mai 2026", is_completed: true, is_current: false },
    { id: "s4", step_number: 4, title: "Election period", title_de: "Wahlzeitraum", description: "10. – 21. June 2026", description_de: "10.–21. Juni 2026", date_label: "10.–21. June 2026", date_label_de: "10.–21. Juni 2026", is_completed: false, is_current: true },
    { id: "s5", step_number: 5, title: "Results", title_de: "Ergebnisse", description: "The result is determined and announced.", description_de: "Das Ergebnis wird ermittelt und bekanntgegeben.", date_label: "June 2026", date_label_de: "Juni 2026", is_completed: false, is_current: false },
  ],
};

export const MOCK_ACHIEVEMENTS: Achievement[] = [
  { id: "a1", stat_value: "28", label: "initiatives", label_de: "Initiativen", description: "improved working conditions", description_de: "verbesserte Arbeitsbedingungen", icon_name: "award", sort_order: 1, created_at: "2026-01-01T00:00:00Z" },
  { id: "a2", stat_value: "156", label: "programs", label_de: "Programme", description: "training & development", description_de: "Weiterbildung & Entwicklung", icon_name: "graduation-cap", sort_order: 2, created_at: "2026-01-01T00:00:00Z" },
  { id: "a3", stat_value: "42", label: "agreements", label_de: "Vereinbarungen", description: "fair agreements achieved", description_de: "faire Vereinbarungen erreicht", icon_name: "handshake", sort_order: 3, created_at: "2026-01-01T00:00:00Z" },
  { id: "a4", stat_value: "€1.2M+", label: "value added", label_de: "Mehrwert", description: "employee benefits secured", description_de: "Mitarbeitervorteile gesichert", icon_name: "heart", sort_order: 4, created_at: "2026-01-01T00:00:00Z" },
];
...
export const MOCK_FAQS: FAQItem[] = [
  ...
  { id: "f3", question: "When does the election take place?", question_de: "Wann findet die Wahl statt?", answer: "The election takes place from 10 to 21 June 2026.", answer_de: "Die Wahl findet vom 10. bis 21. Juni 2026 statt.", category: "Process", sort_order: 3 },
...
export const MOCK_NEWS: NewsUpdate[] = [
  { id: "n1", date: "2026-05-15", title: "Information event about the works council election", title_de: "Informationsveranstaltung zur Betriebsratswahl", summary: "Registration is open for our online information event.", summary_de: "Die Anmeldung für unsere Online-Informationsveranstaltung ist offen." },
  { id: "n2", date: "2026-05-02", title: "Why your voice matters", title_de: "Warum Ihre Stimme wichtig ist", summary: "The works council shapes many decisions that affect your daily work.", summary_de: "Der Betriebsrat gestaltet viele Entscheidungen, die Ihren Arbeitsalltag beeinflussen." },
  { id: "n3", date: "2026-04-25", title: "Election period announced", title_de: "Wahlzeitraum bekanntgegeben", summary: "The works council election will take place from 10.–21. June 2026.", summary_de: "Die Betriebsratswahl findet vom 10.–21. Juni 2026 statt." },
];
